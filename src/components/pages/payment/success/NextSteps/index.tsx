      ...
      <div className="flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center gap-6 md:gap-4 mb-4 md:mb-6">
        ...
        <div className="flex gap-3 md:gap-4">
          <button
            ...
            className="cursor-pointer w-10 h-10 md:w-12 md:h-12 bg-bg-primary rounded-full border border-brand-blue/30 flex items-center justify-center text-text-secondary hover:text-brand-pink transition-all duration-300 group"
          >
