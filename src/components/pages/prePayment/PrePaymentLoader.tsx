...
const OrderDetailsSkeleton: FC = () => (
  <div className="flex-1 animate-pulse">
    ...
    {/* Total */}
    <div className="flex justify-between items-center border-t border-brand-blue/15 pt-4 md:pt-5 lg:pt-6">
...
const PaymentFormSkeleton: FC = () => (
  <div className="flex-1 animate-pulse">
    ...
    <div className="border border-brand-blue/15 rounded w-full mb-4 md:mb-5 lg:mb-6 flex items-center py-1.5 px-2 md:py-2 md:px-3">
    ...
    <div className="border border-brand-blue/15 rounded w-full mb-1 flex items-center py-1.5 px-2 md:py-2 md:px-3">
      <div className="h-5 bg-bg-hover rounded w-1/4"></div>
    </div>
    ...
    {/* Security Message */}
    <div className="border border-brand-blue/15 rounded-xl w-full p-4 md:p-5 lg:p-6 mx-auto flex gap-4">
...
const PrePaymentLoader: FC = () => (
  <section className="pt-14 sm:pb-6 sm:pt-20 md:pb-14 md:pt-28 lg:pt-42 xl:pt-50 lg:pb-28 xl:pb-32 relative overflow-hidden bg-gradient-to-br from-brand-pink/15 to-brand-blue/5">
    <div className="sm:max-w-lg md:max-w-2xl lg:max-w-5xl h-full mx-auto pt-8 px-8 pb-16 sm:py-8 relative z-10 bg-bg-primary sm:rounded-lg sm:border sm:border-brand-blue/15 grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8">
      ...
      <div className="w-px bg-brand-blue/15"></div>
      <PaymentFormSkeleton />
    </div>
  </section>
);
