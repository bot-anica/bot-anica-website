...
const SuccessStoriesSkeleton: FC = () => {
  return (
    <div className="py-20 bg-gray-900 relative overflow-hidden animate-pulse">
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
          {[...Array(4)].map((_, index) => (
            <div key={index} className="text-center">
              <div className="h-10 w-10 bg-gray-700 rounded-full mx-auto mb-4"></div>
              <div className="h-8 bg-gray-600 rounded w-1/4 mx-auto mb-2"></div>
        ...
        {/* CTA Skeleton */}
        <div className="text-center bg-gray-800/50 rounded-2xl p-8">
          <div className="h-16 w-16 bg-gray-700 rounded-full mx-auto mb-4"></div>
          <div className="h-7 bg-gray-600 rounded w-1/2 mx-auto mb-4"></div>
