...
export const HERO_IMAGES: Record<'rightImages' | 'imagesInText', HeroImages> = {
  rightImages: {
    extraLarge: '/images/courses/telegram-rss-bot/heroImage/HeroImageVerticalExtraLarge.png',
    large: '/images/courses/telegram-rss-bot/heroImage/HeroImageVerticalLarge.png',
  },
  imagesInText: {
    medium: '/images/courses/telegram-rss-bot/heroImage/HeroImageHorizontalMiddle.png',
    small: '/images/courses/telegram-rss-bot/heroImage/HeroImageHorizontalSmall.png',
  }
}
